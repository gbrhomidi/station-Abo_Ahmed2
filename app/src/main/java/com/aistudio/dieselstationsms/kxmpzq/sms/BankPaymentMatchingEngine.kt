...
class BankPaymentMatchingEngine {
    ...
    fun match(payment: BankPaymentCandidate, orders: List<CandidateOrder>, now: Long = System.currentTimeMillis()): PaymentMatch {
        ...
        return when {
            ...
            customerMatches.size > 1 -> PaymentMatch(false, true, null, "multiple_customer_orders_same_amount")
            valid.size > 1 -> PaymentMatch(false, true, null, "multiple_orders_same_amount")
