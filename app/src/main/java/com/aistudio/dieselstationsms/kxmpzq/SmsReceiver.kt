 ...
 * ═══════════════════════════════════════════════════════════════
 *
 * تم تحديثه ليتوافق مع المعمارية الجديدة (بدون خادم محلي):
 * - جميع العمليات تعتمد على DatabaseHelper مباشرة
 * - لا يوجد أي اعتماد على NanoHTTPD أو localhost
 * - يعمل بشكل مستقل تماماً عن الخادم
 *
 * التعديلات الجوهرية:
