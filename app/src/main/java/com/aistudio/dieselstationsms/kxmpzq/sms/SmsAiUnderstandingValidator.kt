...
object SmsAiUnderstandingValidator {
    ...
    private val allowedUnits = setOf("DABBA", "DABBAS", "دبة", "دباب", "لتر", "LITER", "LITERS", "LTR", "برميل", "BARREL")
    ...
    fun validate(understanding: SmsAiUnderstanding): SmsAiUnderstanding {
        ...
        sanitizedEntities["fuel"]?.let { fuel ->
            ...
            if (normalizedFuel !in setOf("diesel", "ديزل", "gasoline", "petrol", "بنزين", "بنزين 91", "بنزين 95")) invalid += "invalid_fuel"
        }
