...
fun MaintenanceScreen(
    ...
    var backupId by remember { mutableStateOf("") }
        ...
        LazyColumn(
            ...
            item {
                SettingsCard(title = "النسخ الاحتياطي") {
                    ...
                    OutlinedTextField(
                        value = backupId,
                        onValueChange = { backupId = it },
                        label = { Text("معرف ملف النسخة") },
                    ...
                    ActionButton(
                        ...
                        onClick = { onEvent(SettingsMaintenanceEvent.RestoreBackup(backupId.trim())) }
                    )
                }
            }
